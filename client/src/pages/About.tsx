    ...
    const observer = new IntersectionObserver(
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) entry.target.classList.add("about-animate-in");
        });
      },
      { threshold: 0.08 }
    );
    const el = ref.current;
    if (el) el.querySelectorAll(".about-reveal").forEach((child) => observer.observe(child));
...
export default function About() {
  ...
  return (
    <div ref={containerRef}>
      ...
      <section className="section-dark py-28 md:py-36 relative overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-[oklch(0.62_0.12_75)] text-sm uppercase tracking-[0.2em] font-sans font-medium mb-6 about-reveal">Our Story</p>
            <h1 className="text-4xl md:text-5xl lg:text-6xl text-white leading-[1.1] mb-6 font-serif about-reveal" style={{transitionDelay:'80ms'}}>
              About ASAP Accounting
            </h1>
            <p className="text-white/60 text-lg leading-relaxed mb-10 max-w-2xl mx-auto about-reveal" style={{transitionDelay:'160ms'}}>
              A trusted South Florida accounting firm built on integrity, expertise, and a commitment to your financial success.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center about-reveal" style={{transitionDelay:'240ms'}}>
        ...
        <div className="container">
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
              ...
              <div>
                <p className="text-[oklch(0.62_0.12_75)] text-sm uppercase tracking-[0.15em] mb-3 font-sans font-medium about-reveal">Founded by Susan Rodriguez, CPA</p>
                <h2 className="text-3xl md:text-4xl text-[oklch(0.15_0.01_260)] leading-tight mb-6 font-serif about-reveal" style={{transitionDelay:'80ms'}}>
                  Dedicated to Your Financial Well-Being
                </h2>
                <p className="text-[oklch(0.40_0.01_260)] leading-relaxed mb-4 about-reveal" style={{transitionDelay:'120ms'}}>
                ...
                <p className="text-[oklch(0.40_0.01_260)] leading-relaxed mb-4 about-reveal" style={{transitionDelay:'160ms'}}>
                ...
                <p className="text-[oklch(0.40_0.01_260)] leading-relaxed mb-8 about-reveal" style={{transitionDelay:'200ms'}}>
                ...
                <div className="space-y-3 mb-8">
                  {credentials.map((c, i) => (
                    <div key={i} className="flex items-start gap-3 about-reveal" style={{transitionDelay:`${240 + i * 60}ms`}}>
                ...
                <div className="about-reveal" style={{transitionDelay:'480ms'}}>
      ...
      <section className="section-dark py-20 md:py-28">
        <div className="container">
          <div className="text-center mb-14">
            <p className="text-[oklch(0.62_0.12_75)] text-sm uppercase tracking-[0.15em] mb-3 font-sans font-medium about-reveal">What Guides Us</p>
            <h2 className="text-3xl md:text-4xl text-white leading-tight font-serif about-reveal" style={{transitionDelay:'80ms'}}>Our Core Values</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {values.map((v, i) => (
              <div key={v.title} className="about-reveal border border-white/10 p-8 hover:border-[oklch(0.62_0.12_75)] transition-all duration-300" style={{transitionDelay:`${i * 80}ms`}}>
      ...
      <section className="section-cream py-20 md:py-28">
        <div className="container">
          <div className="max-w-2xl mx-auto text-center about-reveal">
